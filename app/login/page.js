...
export default function Login() {
  return (
    <div
      className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800"
      bis_skin_checked="1"
    >
      ...
      <form noValidate="" action="" className="space-y-6">
        ...
        <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-default-600">
          Sign in
        </button>
      </form>
